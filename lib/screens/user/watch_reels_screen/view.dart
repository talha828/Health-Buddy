...
class WatchReelsScreen extends StatefulWidget {
  const WatchReelsScreen({Key? key}) : super(key: key);

  @override
  State<WatchReelsScreen> createState() => _WatchReelsScreenState();
}

class _WatchReelsScreenState extends State<WatchReelsScreen> {
  @override
