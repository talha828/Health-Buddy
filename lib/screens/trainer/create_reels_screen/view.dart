...
class TrainerCreateReelScreen extends StatefulWidget {
  const TrainerCreateReelScreen({Key? key}) : super(key: key);

  @override
  State<TrainerCreateReelScreen> createState() => _TrainerCreateReelScreenState();
}

class _TrainerCreateReelScreenState extends State<TrainerCreateReelScreen> {
  ...
  final userController=Get.find<TrainerDetailsController>();
  ...
  Future uploadToStorage() async {
    ...
    try {
      ...
      var database=FirebaseFirestore.instance.collection("trainer_video").doc(userController.name.value.toString()).collection(userController.name.value.toString());
      database.doc().set({
